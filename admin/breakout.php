...
<?php
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src="uploads/<?php echo $breakout['topic_image']; ?>" height="40"></td>
      ...
      <a onclick="return confirm('Are you sure you want to delete?')" href="delete_topic.php?id=<?php echo $breakout['topic_id']; ?>" class="btn btn-sm btn-danger">Delete</a> 
